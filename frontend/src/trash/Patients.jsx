...
export default function Patients() {
  ...
  const getDiseaseColor = (disease) => {
    const colors = {
      "Acute Lymphoblastic Leukemia": "bg-red-100 text-red-800",
      "Beta Thalassemia": "bg-blue-100 text-blue-800",
      "Iron Deficiency Anemia": "bg-yellow-100 text-yellow-800",
      "Sickle Cell Disease": "bg-purple-100 text-purple-800",
