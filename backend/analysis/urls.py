...
urlpatterns = [
    ...
    path("patients/<int:pk>/diagnosis-jobs/", DiagnosisJobListAPIView.as_view(), name="diagnosis-job-list"),
    path("patients/<int:pk>/diagnosis-jobs/<uuid:job_id>/", DiagnosisJobAPIView.as_view(), name="diagnosis-job-detail"),
